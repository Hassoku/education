...
class SubscriptionController extends BaseController
{
    ...
    public function packages(){
        ...
        return json_encode(['packages' => ['individual' => $individual, 'grouped' => $grouped]]);
    }
    ...
    public function buy_package(Request $request){
        ...
        //$checkoutId = PaymentCommonHelper::checkOutRequest($subscription_package_id);
        //return json_encode(['status' => 'success', 'checkoutId' => $checkoutId]);
    ...
    public function remaining_minutes(){
        ...
        return json_encode(['status' => 'success', 'group' => $remaining_grouped_minutes, 'individual' => $remaining_individual_minutes]);
    }
}