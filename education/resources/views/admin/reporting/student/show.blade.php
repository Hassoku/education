                    ...
                    <div class="tab-pane active" id="info" aria-expanded="false">
                        <form role="form" method="POST" action="#" enctype="multipart/form-data">
                            <div class="row form-group">
                                ...
                                <div class="col-sm-10">{{ $studentReport->description }}</div>
                            </div>
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-10">{{$studentReport->created_at->format('F j, Y')}}</div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div>
                                        <a href="{{route('admin.tutor.show',['id' => $tutor->id])}}">
                                            <h5>{{$tutor->name}} {{$tutor->middle_name}} {{$tutor->last_name}}</h5>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-sm-2" >
                                    <a href="{{route('admin.tut_std.reporting.student.edit',['id' => $studentReport->id])}}" class="btn btn-fw primary" ><i class="fa fa-edit"></i> Edit </a>
                                </div>
