        ...
        <div class="p-a white lt box-shadow">
            <div class="row">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('admin.tut_std.reporting.tutor')}}">Tutors</a></li>
            ...
            <div class="box padding">
                ...
                <div class="tab-content p-a m-b-md">
                    ...
                    <div class="tab-pane active" id="info" aria-expanded="false">
                        <form role="form" method="POST" action="{{route('admin.tut_std.reporting.tutor.update',['id' => $tutorReport->id])}}" enctype="multipart/form-data">
                            <div class="row form-group">
                                <label class="col-sm-2" for="exampleInputEmail1">Description</label>
                                <div class="col-sm-10">
                                    <input class="form-control" id="" name="description" placeholder="Enter description" value="{{ $tutorReport->description }}">
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="status">
                                        <option value="pending" @if($tutorReport->status == 'pending') selected @endif>Pending</option>
                                        <option value="in-process" @if($tutorReport->status == 'in-process') selected @endif>In-Process</option>
                                        <option value="closed" @if($tutorReport->status == 'closed') selected @endif>Closed</option>
                                    </select>
                                </div>
                            </div>
