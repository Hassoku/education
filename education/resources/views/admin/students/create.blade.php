...
@section('content')
    ...
    <div ui-view class="app-body" id="view">
        ...
        <div class="p-a white lt box-shadow">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-b-0 _300">Add New Student</h4>
                </div>
        ...
        <div class="padding">
            <div class="box padding">
                ...
                <div class="box-header">
                    <img id="profile-img" src="{{asset('assets/student/images/users/default_student_image.jpg')}}" class="circle " width="150" height="150" alt="...">
                   {{-- <div>
                ...
                <div>
                    <form role="form" method="POST" action="{{route('admin.student.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group m-t-lg text-sm-right">
                            <div class="col-sm-12">
                                <button class="btn btn-fw primary" name="publish"><i class="fa fa-user-plus"> Create Student</i></button>
                            </div>
                        </div>
                        {{csrf_field()}}
                    </form>
