    ...
    <div ui-view class="app-body" id="view">
        ...
        <div class="p-a white lt box-shadow">
            <div class="row">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('admin.topics')}}">Topics</a></li>
                    <li class="breadcrumb-item active">Add New Topic</li>
                </ol>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-b-0 _300">Add New Topic</h4>
                </div>
        ...
        <div class="padding">
            <div class="box">
                ...
                <div class="padding">
                    <form role="form" method="POST" action="{{route('admin.topic.store')}}" enctype="multipart/form-data">
                        <div class="row form-group">
                            <label class="col-sm-2" >Topic*</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="" name="topic" placeholder="Enter Topic" required>
                            </div>
                        </div>
                        <div class="row form-group">
                        ...
                        <div class="form-group m-t-lg text-sm-right">
                            <div class="col-sm-12">
                                <button class="btn btn-fw primary" name="publish"><i class="fa fa-plus"></i> Create Topic</button>
                            </div>
                        </div>
                        {{csrf_field()}}
                    </form>
