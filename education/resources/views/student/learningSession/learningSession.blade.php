...
@section('pageTitle', ' Student Learning Session')
    ...
    <script>
        ...
        function participantConnected(participant) {
            ...
            if(participant.identity.substring(0,3).localeCompare("STU")==0) {
                // creating student video div which is local video div
            ...
            if(participant.identity.substring(0,3).localeCompare("TUT")==0){
                ...
                endCallFrom.setAttribute('action',"{{ route('student.learning.session.complete') }}");
